...
$mo_firebase_loginreg_form_css = $mo_firebase_loginreg_form_css_file;
if ( ! is_wp_error( get_mofr_option( 'loginreg_form_css' ) ) ) {
	if ( get_mofr_option( 'loginreg_form_css' ) ) {
		$mo_firebase_loginreg_form_css = get_mofr_option( 'loginreg_form_css' );
	}
}
echo '<style>
				' . esc_attr( $mo_firebase_loginreg_form_css ) . '    
			</style>';
		...
		<div id="mofr-form-container" class="mofr-form-container">
					...
					<form id="mofr_reset_password" class="mofr-forgot-password mofr-flex-column" name="mofr_reset_password">
						<div id="mofr-reset-password" style="display:none;">
							...
							<div class="floating">
								<input name="mofr_reset_pass_email" id="mofr_reset_pass_email" class="mofr-input floating__input" type="email" value="" required placeholder="Email"/>
								<label for="mofr_reset_pass_email" class="floating__label" data-content="' . esc_attr( mofr_( 'Email' ) ) . '">
							</div>

							<div class="mt-regular"></div>
							<input type="button" id="mofr_reset_pass_sendotp" name="mofr_reset_pass_sendotp" class="mofr-button primary" value="' . esc_attr( mofr_( 'Send OTP' ) ) . '">
							...
							<div class="mofr-reset-pass-otp" style="display:none;">
								...
								<div class="floating">
									<input name="mofr_reset_pass_otpfield" id="mofr_reset_pass_otpfield" class="mofr-input floating__input" type="email" value="" required placeholder="Enter Verification Code"/>
									<label for="mofr_reset_pass_otpfield" class="floating__label" data-content="' . esc_attr( mofr_( 'Enter Verification Code' ) ) . '">
								</div>

								<div class="mt-regular"></div>

								<input type="button" id="mofr_reset_pass_verifyotp" name="mofr_reset_pass_verifyotp" class="mofr-input mofr-button primary" value="' . esc_attr( mofr_( 'Verify OTP' ) ) . '">
					...
					<form id="mofr_new_password" class="mofr-save-password mofr-flex-column" name="mofr_new_password">
						<div id="mofr-new-password" style="display:none;" class="mt-large mofr-save-password-section flex-col mofr-tabcontent">
							...
							<div class="relative floating mt-large">
									...
									<input class="mofr-input floating__input" name="mofr_save_new_password" id="mofr_save_new_password" type="password" value="" required placeholder="Enter New Password"/>
									<label for="mofr_save_new_password" class="floating__label" data-content="' . esc_attr( mofr_( 'Enter New Password' ) ) . '">
							</div>

							<div class="mt-large"></div>
							<div class="floating">
									<input class="mofr-input floating__input" name="mofr_confirm_password" id="mofr_confirm_password" type="password" value="" required placeholder="Enter Confirm Password"/>
									<label for="mofr_confirm_password" class="floating__label" data-content="' . esc_attr( mofr_( 'Enter Confirm password' ) ) . '">
							</div>
							<div class="mt-regular"></div>
							...
							<div class="mt-regular"></div>            
							<input type="button" id="mofr_reset_new_pass" name="mofr_reset_new_pass" class="rounded-full mofr-input mofr-button primary" value="' . esc_attr( mofr_( 'Save Password' ) ) . '">
						</div>
					</form>
					...
					<div class="mofr-form-content">
						...
						<div id="signin-section" class="mt-large mofr-signin-section flex-col mofr-tabcontent">
							<form id="mofr-email-login" class="mofr-email-signin mofr-flex-column">
								...
								<div class="floating">
									<input id="mofr_loginwithemail_email" class="mofr-input floating__input" name="mofr_loginwithemail_email" placeholder="Enter Your Email" type="email" value="" required />
									<label for="mofr_loginwithemail_email" class="floating__label" data-content="' . esc_attr( mofr_( 'Email / Username' ) ) . '">
								</div>
								...
								<div class="relative floating mt-large">
									...
									<label for="mofr_loginwithemail_password" class="floating__label" data-content="' . esc_attr( mofr_( 'Password' ) ) . '">
								</div>
								...
								<input type="button" class="mt-regular mofr-button secondary" id="mofr_signin_using_phone" onclick="toggleSignInForm(event,\'mofr_phone_otp_login\',\'mofr-email-login\')" value="' . esc_html( mofr_( 'Sign in with Phone Number' ) ) . '" />
								</div>
								...
								<div id="mofr_phone_otp_login" class="mofr-phone-signin mofr-flex-column mofr-hide">
									<form id="mofr_phone_otp_login_form" class="mofr-email-signin mofr-flex-column"  name="mofr_phone_otp_login_form">
										...
										<div class="floating">
											...
											<label for="mofr_loginwithotp_phone" class="floating__label" data-content="' . esc_attr( mofr_( 'Phone Number' ) ) . '">
										</div>

										<div class="mt-regular"></div>
										<input type="button" id="mofr_loginwithotp_sendotp" name="mofr_loginwithotp_sendotp" class="rounded-full mt-regular mofr-input mofr-button primary" value="' . esc_attr( mofr_( 'Verify Phone Number' ) ) . '">
										...
										<div id= "mofr_loginwithotp_fields" style = "display:none;">
											...
											<div class="mt-large floating">
												...
												<label for="mofr_loginwithotp_otpfield" class="floating__label" data-content="' . esc_attr( mofr_( 'Enter OTP Code' ) ) . '">
											</div>

											<div class="mt-regular"></div>
											<input type="button" id="mofr_loginwithotp_verifyotp" name="mofr_loginwithotp_verifyotp" class="rounded-full mofr-input mofr-button primary" value="' . esc_attr( mofr_( 'Verify & Login' ) ) . '" >
										</div>
										
										<input type="button" class="mt-regular mofr-button secondary" 
											onclick="toggleSignInForm(event,\'mofr-email-login\',\'mofr_phone_otp_login\')" value="' . esc_html( mofr_( 'Sign in using Email/Username' ) ) . '"
										/>
						...
						<div id="signup-section" class="mofr-signup-section mofr-flex-column mofr-tabcontent mofr-hide">
							<form name="moregistrationform" id="moregistrationform" method="post" class="flex flex-col">
								...
								<div class="floating">
									...
									<label for="mofr_reg_username" class="floating__label" data-content="' . esc_attr( mofr_( 'Username' ) ) . '">
								</div>

								<!-- Email Field -->
								<div class="mt-large floating">
									<input class="floating__input" required name="mofr_reg_email" id="mofr_reg_email" placeholder="Email" type="email" />
									<label for="mofr_reg_email" class="floating__label" data-content="' . esc_attr( mofr_( 'Email' ) ) . '">
								</div>
								...
								<div class="mt-large floating">
									...
									<label for="mofr_reg_phone" class="floating__label" data-content="' . esc_attr( mofr_( 'Phone Number' ) ) . '">
								</div>
								<div class="mt-regular"></div>
							

								<div class="otpverificationfields" style="display:' . esc_attr( $show_otp_verification_fields_on_reg_form ) . '">
									<input type="button" class="rounded-full mofr-button secondary" id="miniorange_otp_token_submit_reg"
									...
									<div id="mofr_signupwithotp_fields" style="display:none;">
										...
										<div class="mt-large floating" id="reg_verification_field">
											...
											<label for="mofr_reg_phone" class="floating__label" data-content="' . esc_attr( mofr_( 'Verification Code' ) ) . '">
										</div>

										<input type="button" id="miniorange_otp_token_verify" class="rounded-full mofr-input mofr-button primary" value="' . esc_attr( mofr_( 'Verify OTP' ) ) . '" style="width: 100%; margin-top: 15px; margin-bottom: 15px; margin-right: 0px;">
								...
								<div class="relative floating mt-large">
									...
									<label for="mofr_reg_password" class="floating__label" data-content="' . esc_attr( mofr_( 'Password' ) ) . '">
								</div> 
