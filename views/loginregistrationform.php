...
echo '			<div class="mofr-section-header">
							<p class="mofr-heading grow">MiniOrange Form CSS Settings</p>
						...
						<div class="mofr-content-wrapper">
							<div class="w-1/2 flex flex-col gap-mofr-8">
									...
									<div class="flex w-full gap-mofr-4">
										...
										<p class="mofr-title">Use this shortcode to show the login and registration form <b>[mo_wp_loginreg_form]</b></p>
									</div>
									...
									<div class="flex w-full gap-mofr-4">
										...
										<div>
											...
											<i><u><a href="' . esc_url( $mo_create_new_page ) . '" target="_blank">Click here to create</a></u></i></p>
										</div>
									</div>
...
echo '						<div class="mofr-section-header">
							...
							<div class="px-mofr-4 mt-mofr-4" style="margin-left:2%;">
								...
								<p style="margin-left:2%;margin-top:1%;">
									<i><b>' . esc_html( mofr_( 'Mobile Number Field Meta Key' ) ) . ':</b></i>
										...
										type="text" ' . esc_attr( $prem_disabled ) . '
							...
							<div class="px-mofr-8 py-mofr-4 mt-mofr-4 flex items-center">
								<label class="mofr-checkbox-container pl-mofr-9">
									<input  type="checkbox" ' . esc_attr( $prem_disabled ) . ' id="mo_firebase_um_login_form_enable" value="1" data-toggle="mo_firebase_um_login_form_enable_options" 
									class="sr-only" ' . esc_attr( $mo_firebase_um_login_form_enable ) . ' name="mo_firebase_um_login_form_enable"  />
									<span class="mofr-checkmark"></span>
									<p class="mofr-title">Enable OTP Verification on Ultimate Member Login Form</p>
								</label>             
							</div>
...
echo '						<div class="mofr-section-header">
							...
							<div class="px-mofr-4 mt-mofr-4" style="margin-left:2%;">
								<ol>
									...
									<li>2. ' . wp_kses( mofr_( 'Click on the <b>Edit link</b> of your form.' ), array( 'b' => array() ) ) . '</li>
									<li>4. ' . esc_html( mofr_( 'Add an Phone Field from the list of predefined fields.' ) ) . '</li>
									<li>5. ' . wp_kses( mofr_( 'Set the Format of the Phone Field to <u>International only.</u>' ), array( 'u' => array() ) ) . '</li>
									<li>6. ' . esc_html( mofr_( 'Add a text field with label "Enter Validation Code" in your existing form.' ) ) . '</li>
									<li>7. ' . esc_html( mofr_( 'Add the form id of your form below for which you want to enable Phone verification.' ) ) . '</li>
									<br/><div style="display:flex;    gap: 0.5rem;">' . esc_html( mofr_( 'Add Form' ) ) . ' : <input type="button"  value="+" ' . esc_attr( $prem_disabled ) . '
												...
												$gf_form_results = mofr_get_multiple_form_select(
													$gf_otp_enabled,
													true,
													true,
													$prem_disabled,
						...
						<form name="f" method="post" action="" id="mo_firebase_dropdown_form_settings">
								...
								<input type="hidden" name="nonce_mo_firebase_form_save_option" value="' . esc_attr( $mo_nonce_mo_firebase_form_save_option ) . '" />
									...
									<div class="px-mofr-8 py-mofr-4">
												...
												mofr_multiple_from_select_script_generator( true, true, 'gravity', 'Label', array( 0, $gfcounter2, 0 ), $prem_disabled );
