        ...
        <div class="h-max mofr-content-wrapper flex-col rounded-smooth">
          ...
          <ul>                         
            ...
            <li class="flex flex-row gap-mofr-2 items-center py-mofr-2 text-sm">
                ...
                <p>Replace WooCommerce Login/Registration Form with MiniOrange Login/Registration Form.</p>
            </li>
            ...
            <li class="flex flex-row gap-mofr-2 items-center py-mofr-2 text-sm">
              ...
              <li class="flex flex-row gap-mofr-2 items-center py-mofr-2 text-sm">
                ...
                <p>OTP Verification on the Ultimate Member Login Form.</p>
              </li>
