 ...
 * @return mixed
 */
function mofr_get_multiple_form_select( $form_details, $show_verify_field, $show_email_and_phone_field, $disabled, $key, $form_name, $key_type ) {

	$row_template = "<div id='row{FORM}{KEY}_{INDEX}'>
                            %s : 
                            <input 	id='{FORM}_form_{KEY}_{INDEX}' 
                                    class='field_data' " . esc_attr( $disabled ) . "
	...
	$verify_field = "<span>
                            %s: 
                            <input 	class='field_data' " . esc_attr( $disabled ) . "
 ...
 * @param string $disabled disabled attribute.
 */
function mofr_multiple_from_select_script_generator( $show_verify_field, $show_email_and_phone_field, $form_name, $key_type, $counters, $disabled ) {
	$row_template = "<div id='row{FORM}{KEY}_{INDEX}'>
                            %s : 
                            <input  id='{FORM}_form_{KEY}_{INDEX}' 
                                    class='field_data' " . esc_attr( $disabled ) . "
	...
	$email_and_phone_field = "<span class='{HIDDEN1}'> %s:" . esc_attr( $disabled ) . "
                                    <input 	id='{FORM}_form_email_{KEY}_{INDEX}' 
                                            class='field_data' 
                                            name='{FORM}_form[emailkey][]' 
                                            type='text' value=''>
                                </span>
                                <span class='{HIDDEN2}'> %s: " . esc_attr( $disabled ) . "
                                    <input 	id='{FORM}_form_phone_{KEY}_{INDEX}' 
                                            class='field_data'  
                                            name='{FORM}_form[phonekey][]' 
                                            type='text' 
