...
$log_redirect_page                       = get_mofr_option( 'mofr_login_form_redirecturl' );
...
$reg_redirect_page                       = get_mofr_option( 'mofr_reg_form_redirecturl' );
...
$mo_firebase_wc_new_form_checkout_enable = get_mofr_option( 'wc_new_form_checkout_enable' ) ? 'checked' : '';
...
$mo_firebase_um_login_form_enable        = get_mofr_option( 'um_login_form_enable' ) ? 'checked' : '';
...
$mo_firebase_default_user_role           = get_mofr_option( 'default_user_role' ) ? get_mofr_option( 'default_user_role' ) : 'subscriber';
